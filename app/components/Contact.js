  ...
  return (
    <div className="container mt-5">
      ...
      <div className="form-feature-section">
       ...
       o <div className="feature-column">
          ...
          <div className="icon-row-bottom">
            <span className="follow-text mt-5">Follow-us:</span>

            <Image src="/images/facebooksquare.png" width={50} height={50} className="bottom-icon mt-5" alt="Facebook" />
            <Image src="/images/Instagramlogo.png" width={50} height={50} className="bottom-icon mt-5" alt="Instagram" />
            <Image src="/images/linkedin.png" width={50} height={50} className="bottom-icon mt-5" alt="LinkedIn" />
            <Image src="/images/Twitter.png" width={50} height={50} className="bottom-icon mt-5" alt="Twitter" />
          </div>
